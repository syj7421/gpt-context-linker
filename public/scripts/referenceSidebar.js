function createReferenceSidebar() {
  ...
  referenceSidebar.innerHTML = `
  <button class="reference-sidebar-btn">
  ...
  <div class="reference-sidebar-content">
  ...
  referenceSidebar.querySelector('.reference-sidebar-btn').addEventListener('click', () => {
